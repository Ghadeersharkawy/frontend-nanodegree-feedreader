...
$(function() {
    ...
    */
    ...
    /* This is a test suite named "The menu" */
         ...
         */
         it ('hidden by default', function(){
            const bodyTag = document.querySelector('body').classList.contains('menu-hidden');
            expect(bodyTag).toBe(true);
         });

         /* This is atest that ensures the menu changes
    ...
    /* This is a  test suite named "Initial Entries" */
         ...
         */
             ...
             it('there is at least a single entry element',function(){
                 const feeds = document.querySelector('.feed').querySelectorAll('.entry');
    ...
    describe('New Feed Selection',function(){
        ...
        /* This is a that ensures when a new feed is loaded
